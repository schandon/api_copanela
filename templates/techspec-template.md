...
- Nomes dos componentes e função primarias **Não deixa de listar cada um dos componentes novos ou que serão modificados**
...
[Dfina interfaces de serviço principais (s20 linhas por exemplo):
